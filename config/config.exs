...
config :timing_play_time, TimingPlayTimeWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: TimingPlayTimeWeb.ErrorHTML, json: TimingPlayTimeWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: TimingPlayTime.PubSub,
  live_view: [signing_salt: "ryUE5bCV"]
...
config :timing_play_time, TimingPlayTime.Mailer, adapter: Swoosh.Adapters.Local
